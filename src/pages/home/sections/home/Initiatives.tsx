...
const Initiatives: React.FC<{ lang: "hi" | "en" }> = ({ lang }) => {
  ...
  const initiatives = [
    { 
      ...
      desc: isHi ? "सड़क निर्माण के लिए MLP का प्रसंस्करण।" : "MLP shredding for roads.", 
      img: "/plasticwaste/3.jpg", 
      grid: "md:col-span-2 md:row-span-2",
      path: "/plastic-recycling" // पाथ जोड़ें
    },
    { 
      title: isHi ? "ई-कचरा" : "E-Waste", 
      icon: <Zap size={24} />, 
      desc: isHi ? "सुरक्षित निराकरण।" : "Safe dismantling.", 
      img: "/ewaste/2.jpg", 
      grid: "md:col-span-1 md:row-span-1",
      path: "/e-waste"
    },
    { 
      title: isHi ? "जैविक अपशिष्ट" : "Organic", 
      icon: <Sprout size={24} />, 
      desc: isHi ? "बायोगैस सिस्टम।" : "Biogas systems.", 
      img: "/organicwaste/5.jpg", 
      grid: "md:col-span-1 md:row-span-1",
      path: "/organic-waste"
    },
    { 
      title: isHi ? "सामाजिक समावेशन" : "Social", 
      icon: <HardHat size={24} />, 
      desc: isHi ? "मित्रों का सशक्तिकरण।" : "Empowering Mitras.", 
      img: "/img/37.jpeg", 
      grid: "md:col-span-1 md:row-span-2",
      path: "/social-inclusion"
    },
    { 
      title: isHi ? "औद्योगिक" : "Industrial", 
      icon: <Factory size={24} />, 
      desc: isHi ? "सह-प्रसंस्करण।" : "Co-processing.", 
      img: "/zerowaste/6.jpg", 
      grid: "md:col-span-1 md:row-span-1",
      path: "/industrial-waste"
    },
    { 
      title: isHi ? "ज़ीरो वेस्ट" : "Zero Waste", 
      icon: <Recycle size={24} />, 
      desc: isHi ? "शून्य अपशिष्ट आयोजन।" : "Zero-waste events.", 
      img: "/zerowaste/8.jpg", 
      grid: "md:col-span-1 md:row-span-1",
      path: "/zero-waste-campus"
    },
    { 
      title: isHi ? "कृषि अपशिष्ट" : "Agri Waste", 
      icon: <Wheat size={24} />, 
      desc: isHi ? "बायो-ऊर्जा।" : "Bio-energy.", 
      img: "/img/12.jpeg", 
      grid: "md:col-span-1 md:row-span-1",
      path: "/agri-waste"
    }
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:auto-rows-[220px] group/main">
          {initiatives.map((item, idx) => (
            <motion.div
              ...
              className={`${item.grid} relative overflow-hidden rounded-[2.5rem]`}
            >
              {/* पूरे कार्ड को Link बनाया गया है */}
              <Link
                to={item.path}
                className="block w-full h-full relative cursor-pointer group min-h-[250px] md:min-h-full transition-all duration-700 md:group-hover/main:opacity-40 md:hover:!opacity-100 md:hover:scale-[1.02]"
              >
                {/* Background Image */}
                <img 
                  src={item.img} 
